...
if ( !file_exists(@phpbb_realpath($phpbb_root_path . 'language/lang_' . $language . '/lang_main_album.'.$phpEx)) )
{
	$language = 'english';
}
...
// Get Album Config
//
if ( $check_cache = sql_cache('check', 'album_config') )
{
	include($check_cache);
}
else
{
	...
	sql_cache('write', 'album_config', $album_config);
}
//
// Set ALBUM Version
//
