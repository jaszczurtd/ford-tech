...
function write_db_backup(&$file_handle, &$str)
{
	...
	if ($bytes === false)
	{
		...
		message_die(GENERAL_ERROR, 'Unable to write backup file. Check you have enough free space.<br />Nie mog� utworzy� kopii. Sprawd�, czy na serwerze jest wystarczaj�ca ilo�� wolnego miejsca.', 'Could not write backup file', __LINE__, __FILE__);
	}
