...
class Template {
	...
	var $xs_started = 0;
	var $xs_version = 7; // number version. internal. do not change.
	var $xs_versiontxt = '2.2.1'; // text version
	...
	// PHP 4/5 old-style constructor alias
	...
	function compile_code($filename, $code, $use_isset = false)
	{
		...
		$search = array('<!-- PHP -->', '<!-- ENDPHP -->', '"templates', '"images');
		$replace = array('<'.'?php ', ' ?'.'>', '"<?php echo $subdirectory; ?>templates', '"<?php echo $subdirectory; ?>images');
