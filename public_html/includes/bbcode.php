...
$bbcode_tpl['youtube'] = str_replace('{YOUTUBEID}', '\\2', $bbcode_tpl['youtube']); //YouTube Tag
...
$patterns[] = "#\[youtube\](?:https?://)?(?:(?:[\w-]+\.)?youtube(?:-nocookie)?\.com/(?:(?:watch\?(?:[^]]*?[?&])?v=)|embed/|shorts/)|(?:[\w-]+\.)?youtu\.be/)([0-9A-Za-z_-]{11})([^]]*)\[/youtube\]#is";
$patterns[] = "#\[youtube\]\s*([0-9A-Za-z_-]{11})([^]]*)\s*\[/youtube\]#i";
$replacements[] = '
<div class="youtube-container">
  <iframe src="https://www.youtube.com/embed/$1$2" frameborder="0" allowfullscreen></iframe>
</div>';
$replacements[] = '
<div class="youtube-container">
  <iframe src="https://www.youtube.com/embed/$1$2" frameborder="0" allowfullscreen></iframe>
...
function bbencode_first_pass($text, $uid)
{
	...
	// [img]image_url_here[/img] code..
	$text = preg_replace_callback("#\[img\]((http|ftp|https|ftps)://)([^\r\n\t<\"]*?)\[/img\]#si", function($m) use ($uid) {
		return '[img:' . $uid . ']' . $m[1] . str_replace(array(' ', '&amp;'), array('%20', '&'), $m[3]) . '[/img:' . $uid . ']';
	}, $text);
