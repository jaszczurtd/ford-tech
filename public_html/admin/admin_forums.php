	...
	switch($mode)
	{
		...
		case 'editforum':
			...
			$template->assign_vars(array(
				...
				'L_FORUM_LOGO' => $lang['Forum_logo'],
                        'L_FORUM_LOGO_EXPL' => $lang['Forum_logo_expl'],
				...
				'TOPIC_TAGS' => htmlspecialchars($topic_tags),
