 ...
 *   date modification    : ver. 1.12.0 2005/11/11 15:04
 *
...
if( $mode != "" )
{
	...
	else if( $mode == "save" )
	{
		...
		$word = ( isset($HTTP_POST_VARS['word']) ) ? $HTTP_POST_VARS['word'] : "";
		$replacement = ( isset($HTTP_POST_VARS['replacement']) ) ? $HTTP_POST_VARS['replacement'] : "";
