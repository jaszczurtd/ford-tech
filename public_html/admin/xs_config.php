...
{
	$vars = array('xs_use_cache', 'xs_auto_compile', 'xs_auto_recompile', 'xs_php', 'xs_def_template', 'xs_check_switches', 'xs_warn_includes', 'xs_ftp_host', 'xs_ftp_login', 'xs_ftp_path', 'xs_shownav');
