...
if(isset($HTTP_GET_VARS['mode']) || isset($HTTP_POST_VARS['mode']))
{
	...
	switch($mode)
	{
		...
		case 'block_new':
			$blocks[] = htmlspecialchars(stripslashes(isset($HTTP_GET_VARS['block_title']) ? $HTTP_GET_VARS['block_title'] : $HTTP_POST_VARS['block_title']));
			$quests[] = array();
			break;
		...
		case 'block_edit':
			...
			$template->assign_vars(array(
				...
				'BLOCK_TITLE' => htmlspecialchars($blocks[$block_no]),
