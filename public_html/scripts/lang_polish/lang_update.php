...
$lang['update_body'] = '<b>Modyfikacja forum do wersji phpBB modified v1.12.7 by Przemo</b></span><br /><span class="gensmall">U¿yj aby zamieniæ oryginalne phpBB 2.0.* lub uaktualniæ z dowolnej wersji phpBB modified by Przemo z przedzia³u: 1.5 - 1.12.6</span></td></tr>
...
$lang['result'] = '<b>Wynik aktualizacji bazy do wersji phpBB modified v1.12.7 by Przemo</b><br />Instrukcji wykonanych: <b>%s</b>, niewykonanych: <b>%s</b><br /><br />&bull;Sprawd¼ poni¿sze instrukcje SQL<br /><span class="gensmall">' . $lang['No_query_info'] . '</span><br /><br />&bull; Nadpisz wszystkie pliki  oprócz <i><b>config.php</b></i><br />&bull; Sprawd¼ w Panelu Admina: Kontrolê Systemu, zwróæ uwagê na prawa katalogów do zapisu<br />&bull; Je¿eli aktualizujesz z oryginalnego phpBB popraw w Panelu Admina i przenie¶ do katalogu stylu obrazki rang<br />&bull; <span class="gensmall">Je¿eli aktualizujesz z wersji "by Przemo" mniejszej ni¿ 1.12.7 mo¿esz u¿yæ pliku <a href="update_useragent.php" target="_blank">/scripts/update_useragent.php</a> aby dostosowaæ ikony przegl±darek dla "starych" postów (u¿yj po wys³aniu nowych plików) </span><br />&bull; Dopasuj nowe kolory Admina, JR Admina, Moderatorów, kolorów OnMouseOver w Panelu Admina w edycji danych stylu';
