...
write_msg(_CHATBOX_SYSTEM_MSG,"<span style='color: #006600'><b><i>$nick</b> has joined chat on " . create_date($board_config['default_dateformat'], CR_TIME, $board_config['board_timezone']) . "</i></span>","");
