...
<link rel="stylesheet" href="../templates/VipLight/{T_HEAD_STYLESHEET}" type="text/css">
<style type="text/css">
<!--
p, td		{ font-size : 11; }
h1,h2		{ font-family: "Trebuchet MS", Verdana, Arial, Helvetica, sans-serif; font-size : 19px; font-weight : bold; text-decoration : none; line-height : 100%; color : #000000;}
-->
</style>
