...
<table width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
   <tr>
      <td align="left" valign="bottom"><span class="gensmall">
		...
		<!-- END switch_user_logged_in -->
		<!-- BEGIN switch_user_logged_out -->
		<span class="gensmall"><input class="post" onFocus="Active(this); this.value=''" onBlur="NotActive(this)" type="text" name="username" size="8" value="Wpisz nazwê u¿ytkownika..."/>&nbsp;<input class="post" onFocus="Active(this); this.value=''" onBlur="NotActive(this)" type="password" name="password" value="000000" size="8">
   ...
   <table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
      ...
      <tr>
         <td class="row1" {ONMOUSE_COLORS}align="center" valign="middle" rowspan="6">
            <img src="templates/VipLight/images/whosonline.gif" width="46" height="25" alt=""></td>
