...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
	...
	<tr>
		<td class="row1" align="{REGISTER_ALIGN}"><span class="gensmall">{L_EMAIL}:<input type="text" class="post" name="email1" style="width:60px" maxlength="200" value="" /> <span class="genmed">@</span> <input type="text" class="post" name="email2" style="width:60px" maxlength="200" value="" />
</span></td>
	</tr>
	<tr>
