...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
	...
	<tr>
		...
		<!-- BEGIN admin -->
		<a href="{U_ADMIN_EDIT}" target="_blank">{L_EDIT}</a>&nbsp;&bull;
		<a href="{U_ADMIN_PERMISSION}" target="_blank">{L_PERMISSIONS}</a>&nbsp;&bull;
		<!-- END admin -->
		<!-- BEGIN add_warning -->
		<a href="{U_ADD_WARNING}">{L_ADD_WARNING}</a>&nbsp;&bull;
		<!-- END add_warning -->
		<!-- BEGIN topic_spy -->
	...
	<tr>
		<td class="row1" height="6" valign="top" align="center"><table cellspacing="0" cellpadding="0" border="0" align='center'><tr>
<td><img src="templates/ApartDark/images/cien/gora_lewa.png"  height="12" width="12"></td>
<td><img src="templates/ApartDark/images/cien/gora_srodek.png"  height="12" width="100%"></td>
<td><img src="templates/ApartDark/images/cien/gora_prawa.png"  height="12" width="12"></td></tr>
<td align='left'><img src="templates/ApartDark/images/cien/srodek_lewa.png" width="12" height="100%"></td>
<td align='center' height='1%'>{AVATAR_IMG}</td>
<td align='right'><img src="templates/ApartDark/images/cien/srodek_prawa.png" height="100%" width="12"></td></tr><tr>
<td><img src="templates/ApartDark/images/cien/dol_lewa.png" height="12" width="12"></td>
<td><img src="templates/ApartDark/images/cien/dol_srodek.png" height="12" width="100%"></td>
<span class="postdetails">{POSTER_RANK}{CUSTOM_RANK}{RANK_IMAGE}</span>
<td><img src="templates/ApartDark/images/cien/dol_prawa.png" height="12" width="12"></td></tr>
</tr></table>
			<!-- BEGIN signature -->
				...
				<tr> 
					...
					<tr> 
						<td colspan="3" width="100%" class="row2">
							...
							<tr> 
								<td bgcolor="{T_TD_COLOR2}"><img src="templates/ApartDark/images/spacer.gif" width="{UPLOAD_LIMIT_IMG_WIDTH}" height="8" alt="{UPLOAD_LIMIT_PERCENT}"></td>
							</tr>
							</table>
						</td>
					</tr>
