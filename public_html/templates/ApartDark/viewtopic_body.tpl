...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0">
   ...
   <!-- END post_tree -->
   <tr>
      <td align="center" valign="top" class="{postrow.ROW_CLASS}" nowrap="nowrap" width="150">
         ...
         <span class="postdetails">{postrow.CUSTOM_RANK}{postrow.RANK_IMAGE}
...
<td align='center' height='1%'>{postrow.POSTER_AVATAR}</td>
...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
   ...
   <tr> 
      <td align="left" valign="middle" nowrap><span class="nav"><a href="{U_POST_NEW_TOPIC}"><img src="{POST_IMG}" border="0" alt="{L_POST_NEW_TOPIC}" align="middle"></a>&nbsp;<a href="{U_POST_REPLY_TOPIC}"><img src="{REPLY_IMG}" border="0" alt="{L_POST_REPLY_TOPIC}" title="{L_POST_REPLY_TOPIC}" align="middle"></a></span></td>
