...
<table class="forumline" width="100%" cellpadding="4" cellspacing="1" border="0">
	...
	<tr> 
		...
		<td class="row2" valign="middle"><span class="genmed"><select class="post" name="search_time">{S_TIME_OPTIONS1}</select>		<br><input type="radio" name="search_fields" value="all" checked="checked"> {L_SEARCH_MESSAGE_TITLE}<br>
