...
<table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
	...
	<tr>
		<td class="row1" colspan="{SPAN_J}" align="center" height="28"><span class="gensmall">
			...
			<input type="submit" name="ignore" class="liteoption" onclick="setCheckboxes('ignoreform', true); return false;" value="{ignore_form.L_MARK_ALL}"<!-- BEGIN overlib --> onMouseOver="return overlib('<left>Opcja zaznacza wszystkie tematy na przegl±danej stronie.</left>', ol_offsetx=-203, ol_offsety=8, CAPTION, '<center>{ignore_form.L_MARK_ALL}</center>')" onMouseOut="nd();"<!-- END overlib -->>
		</span></td>
	</tr>
	<!-- END ignore_form -->
