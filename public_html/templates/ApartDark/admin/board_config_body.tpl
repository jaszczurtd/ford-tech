		...
		<tr>
			...
			<script language=JavaScript src="../images/picker.js"></script>
				...
				<tr>
					...
					<td class="row2" width="50%"><input type="text" class="post" onFocus="Active(this)" onBlur="NotActive(this)" name="smtp_username" value="{SMTP_USERNAME}" size="25" maxlength="255"></td>
				</tr>
				<tr>
					<td class="row1">{L_SMTP_PASSWORD}<br><span class="gensmall">{L_SMTP_PASSWORD_EXPLAIN}</span></td>
					<td class="row2" width="50%"><input type="password" class="post" onFocus="Active(this)" onBlur="NotActive(this)" name="smtp_password" value="{SMTP_PASSWORD}" size="25" maxlength="255"></td>
				</tr>
				<tr>
