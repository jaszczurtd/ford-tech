...
function checkAlbumForm() {
	...
	var fileCount = (fileInput && fileInput.files) ? fileInput.files.length : (fileInput && fileInput.value && fileInput.value.length > 0 ? 1 : 0);
...
function submitWithProgress() {
	...
	box.style.cssText = 'background:#1e1e2e;border:2px solid #006699;border-radius:8px;padding:30px 40px;text-align:center;min-width:350px;font-family:Verdana,Arial,sans-serif;';
	...
	barFill.style.cssText = 'background:linear-gradient(90deg,#006699,#3399cc);height:100%;width:0%;transition:width 0.15s;border-radius:4px;';
...
<!-- END switch_user_logged_out -->
  ...
  <tr>
	<td class="row1" colspan="2"><span class="gensmall" style="display:block;padding:6px 8px;background:#e8eef4;border-left:3px solid #006699;line-height:1.6;">Mo&#380;esz doda&#263; kilka zdj&#281;&#263; na raz. Kliknij przycisk &quot;Wybierz plik&quot;, a nast&#281;pnie &mdash; trzymaj&#261;c wci&#347;ni&#281;ty klawisz <b>Ctrl</b> &mdash; klikaj kolejne zdj&#281;cia.<br>Tytu&#322; jest opcjonalny: je&#347;li go nie wpiszesz, ka&#380;de zdj&#281;cie otrzyma tytu&#322; taki jak nazwa pliku.</span></td>
  </tr>
  <tr>
