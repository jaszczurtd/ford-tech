...
$search_fields = $HTTP_POST_VARS['search_fields'];

$return_chars = (isset($HTTP_POST_VARS['return_chars'])) ? intval($HTTP_POST_VARS['return_chars']) : -1;
...
$search_author = ( phpbb_clean_username($HTTP_GET_VARS['search_author_all']) == '*' ) ? '*' : $search_author;
...
for($i = 0; $i < count($previous_days); $i++)
{
	...
	if($previous_days_text[$i] != $lang['All_Posts'])
	{
